    ...
    ($target:ty $(where [$($generics:tt)*])?) => {
        $crate::macros::delegate_impls_to_as_ref!(
            ...
            StorageRootProvider $(where [$($generics)*])? {
                ...
                fn storage_root_from_nodes(&self, input: reth_trie::StorageTrieInput, address: alloy_primitives::Address) -> reth_storage_api::errors::provider::ProviderResult<alloy_primitives::B256>;
                fn storage_proof(&self, input: reth_trie::StorageTrieInput, address: alloy_primitives::Address, slot: alloy_primitives::B256) -> reth_storage_api::errors::provider::ProviderResult<reth_trie::StorageProof>;
                fn storage_multiproof(&self, input: reth_trie::StorageTrieInput, address: alloy_primitives::Address, slots: &[alloy_primitives::B256]) -> reth_storage_api::errors::provider::ProviderResult<reth_trie::StorageMultiProof>;
            }
